...
export default function AdminCustomOrders() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      if (data.success) {
        // Filter for custom orders only
        const customOrders = data.data.filter((o: Order) => o.type === 'custom');
    ...
    >
      ...
      <AnimatePresence>
        {selectedOrder && (
          ...
          >
            <motion.div
              className="max-w-3xl w-full mx-auto p-8 rounded-2xl max-h-[90vh] overflow-y-auto"
              style={{
                backgroundColor: colors.bgSecondary,
                ...neumorph
              }}
